const virtuosoQueries = [
    ...
    {title:"Articles discussing drugs of the VIRAL VACCINES family  and COVID-19",
    description:"Paragraphs that mention drugs of the VIRAL VACCINES family (ATC J07B) and COVID-19, and the title and source of the corresponding paper.",
    ...
    {
        title:"Federated query (Extension of query 1): Articles discussing amphotericin B and COVID-19.",
        description:"Paragraphs that mention a certain active substance and a certain disorder, and the name and authors (retrieved from an external KG) of the corresponding paper.\nInstances: amphotericin B , Disorder: COVID-19 MESHCode C000657245.",
